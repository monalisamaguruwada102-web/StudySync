...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const navItems = [
        ...
        { icon: CalendarCheck, label: 'Auto Planner', path: '/planner', gradient: 'from-pink-500 to-rose-500' },
    ...
    return (
        <>
            ...
            >
                ...
                {/* Logo Section */}
                <motion.div
                    className="p-6 flex items-center justify-between gap-3 relative z-10"
                ...
                >
                    <div className="flex items-center gap-3">
                        <motion.div
                            className="w-12 h-12 bg-gradient-to-br from-primary-600 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-primary-500/30 relative overflow-hidden"
                ...
                {/* Level Progress Card */}
                <motion.div
                    className="mx-4 mb-6 p-5 bg-gradient-to-br from-slate-50 to-white dark:from-slate-800/50 dark:to-slate-900/50 rounded-3xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-slate-200/50 dark:shadow-black/20 relative overflow-hidden group"
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-2">
                                <motion.div
                                    className="p-2 bg-gradient-to-br from-primary-500 to-purple-500 rounded-xl text-white shadow-lg shadow-primary-500/30"
                        ...
                        <div className="h-2.5 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner relative">
                            <motion.div
                                className="h-full bg-gradient-to-r from-primary-500 via-purple-500 to-pink-500 rounded-full shadow-lg shadow-primary-500/50 relative"
                                initial={{ width: 0 }}
                            ...
                            >
                                {({ isActive }) => (
                                    <>
                                        ...
                                        <motion.div
                                            className={`relative z-10 ${isActive ? `text-transparent bg-gradient-to-r ${item.gradient} bg-clip-text` : ''}`}
