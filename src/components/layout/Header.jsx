...
import {
    ...
    Music, Terminal, ShoppingBag, Map, Users, Swords, Heart, BookOpen, Shield, FileText, Zap
} from 'lucide-react';
            ...
            <header className="h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30 transition-all duration-300">
                ...
                <div className="flex items-center gap-2 sm:gap-6">
                    ...
                    <div className="relative group/nav hidden sm:block">
                        ...
                        <div className="absolute top-full right-0 pt-3 opacity-0 translate-y-2 invisible group-hover/nav:opacity-100 group-hover/nav:translate-y-0 group-hover/nav:visible transition-all duration-300 ease-out z-50 w-[300px]">
