    ...
    React.useEffect(() => {
        if ('webkitSpeechRecognition' in window) {
            ...
            tempRecognition.onend = () => {
                // Auto-restart if still 'recording' state is true? 
                // Usually better to just let it stop or handle manual restart.
                // For now we assume user toggles it off manually to stop processing.
