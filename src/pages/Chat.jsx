...
function Chat() {
    ...
    // --- Handlers ---
    // Simplified logic: filter current user on frontend, backend returns all
    async function fetchUsers() {
        ...
        try {
            ...
            // Fallback: If /users/all fails, we rely on active conversations to populate known users
        } finally {
