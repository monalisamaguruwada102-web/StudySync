...
const runDailyReports = async () => {
    console.log('≡ƒÜÇ Starting daily study report process...');
    ...
    console.log('Γ£à Daily study reports completed.');
};
...
const initScheduler = () => {
    ...
    cron.schedule('45 1 * * *', () => {
        console.log('ΓÅ░ 1:45 AM - Triggering daily study reports...');
        runDailyReports();
    });

    console.log('≡ƒôà Scheduler initialized: Daily reports set for 01:45 AM');
};
